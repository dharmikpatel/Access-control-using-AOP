...
public interface IFileService {
	 ...
	 */
	void shareFile(String userId, String targetUserID, String filePath) throws Exception;
	/**
	 ...
	 * @param filePath location of the file to be shared.
	 */
	void unshareFile(String userId, String targetUserID, String filePath) throws Exception;
	/**
	 ...
	 */
	byte[] readFile(String userId, String filePath) throws Exception;
